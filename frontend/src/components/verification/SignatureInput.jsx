/**
 * @file Controlled signature input with a generate helper hook-in.
 */
 ...
 * @param {() => void} props.onGenerate - Fill the input with a fresh legitimate signature.
 ...
 */
export default function SignatureInput({ value, onChange, onGenerate, onSubmit, busy = false }) {
  return (
    <div className="flex flex-wrap gap-2">
      ...
      <button
        type="button"
        onClick={onGenerate}
        className="rounded border border-quantum-purple/50 bg-quantum-purple/20 px-3 py-2 text-sm text-purple-200 hover:bg-quantum-purple/30"
      >
